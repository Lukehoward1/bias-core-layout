    ...
    <div class="pdf-header">
      ...
      <div class="pdf-user-info">
        <div class="pdf-user-details">
          <div class="pdf-user-name">${options.userName || 'Trader'}</div>
          <div class="pdf-report-type">Trading Performance Report</div>
          <div class="pdf-date-range">Period: ${options.dateRange}</div>
        </div>
...
const createMiniHeader = (options: ExportOptions) => `
  <div class="pdf-mini-header">
    ...
    <div class="pdf-mini-user">${options.userName || 'Trader'} • ${options.dateRange}</div>
  </div>
`;

const createFooter = (pageNum: number, totalPages: number) => `
  <div class="pdf-footer">
    <div class="pdf-footer-left">Generated by StreamBias</div>
    <div class="pdf-footer-center">app.streambias.com</div>
    <div class="pdf-footer-right">Page ${pageNum} of ${totalPages}</div>
  </div>
`;
  ...
  const exportToPdf = useCallback(async (elementId: string, options: ExportOptions) => {
    ...
    wrapper.innerHTML = `
      ...
      <div style="background: #0a0a0a; color: #fafafa; min-height: 100vh;">
        ...
        <div class="pdf-section-title">${options.title}</div>
      ...
      if (element) {
        ...
        htmlContent += `
          <div ${pageBreak}>
            ...
            <div class="pdf-section-title">${section.title.toUpperCase()}</div>
