          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-start space-x-2 p-3 rounded-lg border border-border hover:bg-muted/50 transition-colors">
                ...
                <div>
                  <Label htmlFor="wick" className="cursor-pointer font-medium">Wick / Touch</Label>
              ...
              <div className="flex items-start space-x-2 p-3 rounded-lg border border-border hover:bg-muted/50 transition-colors">
                ...
                <div>
                  <Label htmlFor="close" className="cursor-pointer font-medium">Close Above/Below</Label>
                  <p className="text-xs text-muted-foreground mt-0.5">
          ...
          <div className="space-y-2">
            ...
            {selectedAsset && (
              <p className="text-xs text-muted-foreground">
                Current price: {selectedAsset.latestPrice}
              </p>
            )}
          </div>
