...
export const DASHBOARD_CARD_REGISTRY: DashboardCardDefinition[] = [
  ...
  },
  {
    ...
    description: "Summary of pending, live, recurring, and active price alerts",
    section: "alerts",
    category: "overview",
    defaultRowType: "equal",
    allowedRowTypes: ["equal", "wide-narrow", "hero", "three-equal", "four-equal"],
    dashboardEligible: true,
  },
  ...
  // ============ Risk Tools ============
  {
    ...
    description: "Fast position sizing with default risk settings",
    section: "risk-tools",
    category: "analysis",
    defaultRowType: "equal",
    allowedRowTypes: ["equal", "wide-narrow", "hero"],
  ...
  },
  {
    ...
    description: "Full position sizing with entry, stop, and target",
    section: "risk-tools",
    category: "analysis",
    defaultRowType: "hero",
    allowedRowTypes: ["hero", "equal", "wide-narrow"],
  ...
  },
  {
    ...
    description: "Track your daily loss limit usage",
    section: "risk-tools",
    category: "overview",
    defaultRowType: "equal",
    allowedRowTypes: ["equal", "wide-narrow", "kpi"],
    dashboardEligible: true,
  },
  {
    id: "max-drawdown-guard",
    title: "Max Drawdown Guard",
    description: "Visual drawdown tracking against your limit",
    section: "risk-tools",
    category: "overview",
    defaultRowType: "equal",
    allowedRowTypes: ["equal", "wide-narrow"],
...
export const getCardsGroupedByCategory = (): Record<string, DashboardCardDefinition[]> => {
  return DASHBOARD_CARD_REGISTRY.reduce(
    (acc, card) => {
