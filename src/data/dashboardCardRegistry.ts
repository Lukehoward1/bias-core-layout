...
export const DASHBOARD_CARD_REGISTRY: DashboardCardDefinition[] = [
  ...
  {
    id: 'reports-overview-kpis',
    title: 'Overview KPIs',
    description: 'Total P&L, Win Rate, Avg RR, Expectancy',
    section: 'reports',
    category: 'metrics',
    defaultRowType: 'kpi',
    allowedRowTypes: ['kpi'],
  ...
  {
    id: 'reports-overview-best-worst',
    title: 'Best/Worst Days',
    description: 'Best winning day and worst losing day',
    section: 'reports',
    category: 'overview',
    defaultRowType: 'equal',
