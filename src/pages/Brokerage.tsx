                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <Badge variant="outline" className="text-[10px] sm:text-xs">{broker.execution}</Badge>
                        </div>
                        <div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <Badge variant="outline" className="text-[10px] sm:text-xs">{firm.evaluation}</Badge>
                        </div>
                        <div>
                          <span className="text-xs sm:text-sm text-muted-foreground">Instruments</span>
                      ...
                      <tbody>
                        {brokers.map((broker) => (
                          <tr key={broker.name} className="border-b border-border">
                            ...
                            <td className="py-3 px-4 text-xs text-muted-foreground">{broker.commission.split(" or ")[0]}</td>
                            <td className="py-3 px-4">
                              <Badge variant="outline" className="text-[10px]">{broker.execution}</Badge>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                      ...
                      <tbody>
                        {propFirms.map((firm) => (
                          <tr key={firm.name} className="border-b border-border">
                            ...
                            <td className="py-3 px-4 text-xs sm:text-sm text-foreground">{firm.profitTarget.split(" (")[0]}</td>
                            <td className="py-3 px-4 text-xs text-muted-foreground">{firm.drawdown.split(" / ")[0]}</td>
                            <td className="py-3 px-4">
                              <Badge variant="outline" className="text-[10px]">{firm.evaluation}</Badge>
                            </td>
                            <td className="py-3 px-4 text-xs sm:text-sm text-foreground">{firm.typicalFee.split(" (")[0]}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                    ...
                    <CardContent className="pt-6 pb-6">
                      {smartMatchStep === 0 && (
                        <div className="space-y-5">
                          <h3 className="text-base sm:text-lg font-semibold text-foreground">What assets do you primarily trade?</h3>
                          <RadioGroup 
                          ...
                          >
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              ...
                              <Label htmlFor="forex" className="cursor-pointer flex-1 text-sm sm:text-base">Forex & CFDs</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="futures" id="futures" />
                              <Label htmlFor="futures" className="cursor-pointer flex-1 text-sm sm:text-base">Futures</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="crypto" id="crypto" />
                              <Label htmlFor="crypto" className="cursor-pointer flex-1 text-sm sm:text-base">Crypto</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="mixed" id="mixed" />
                              <Label htmlFor="mixed" className="cursor-pointer flex-1 text-sm sm:text-base">Multiple asset classes</Label>
                            </div>
                          </RadioGroup>
                        </div>
                      )}
                      ...
                      {smartMatchStep === 1 && (
                        <div className="space-y-5">
                          <h3 className="text-base sm:text-lg font-semibold text-foreground">What's your pricing preference?</h3>
                          <RadioGroup 
                          ...
                          >
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              ...
                              <Label htmlFor="spreads" className="cursor-pointer flex-1 text-sm sm:text-base">Spread-only (no commission)</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="raw" id="raw" />
                              <Label htmlFor="raw" className="cursor-pointer flex-1 text-sm sm:text-base">Raw spreads + commission</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="nopreference" id="nopreference" />
                              <Label htmlFor="nopreference" className="cursor-pointer flex-1 text-sm sm:text-base">No preference</Label>
                            </div>
                          </RadioGroup>
                        </div>
                      )}
                        ...
                        <div className="space-y-5">
                          ...
                          >
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              ...
                              <Label htmlFor="personal" className="cursor-pointer flex-1 text-sm sm:text-base">Personal brokerage account</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="funded" id="funded" />
                              <Label htmlFor="funded" className="cursor-pointer flex-1 text-sm sm:text-base">Funded/prop firm account</Label>
                            </div>
                          </RadioGroup>
                        </div>
                      )}
                      ...
                      {smartMatchStep === 3 && (
                        <div className="space-y-5">
                          <h3 className="text-base sm:text-lg font-semibold text-foreground">What's most important to you?</h3>
                          <RadioGroup 
                          ...
                          >
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              ...
                              <Label htmlFor="speed" className="cursor-pointer flex-1 text-sm sm:text-base">Fast payouts</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="scaling" id="scaling" />
                              <Label htmlFor="scaling" className="cursor-pointer flex-1 text-sm sm:text-base">Scaling opportunities</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="cost" id="cost" />
                              <Label htmlFor="cost" className="cursor-pointer flex-1 text-sm sm:text-base">Lower fees/costs</Label>
                            </div>
                            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border hover:border-primary/30 cursor-pointer">
                              <RadioGroupItem value="flexibility" id="flexibility" />
                              <Label htmlFor="flexibility" className="cursor-pointer flex-1 text-sm sm:text-base">Flexible rules</Label>
                            </div>
                          </RadioGroup>
                        </div>
                      )}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <h4 className="font-medium text-foreground text-sm sm:text-base">{provider.name}</h4>
