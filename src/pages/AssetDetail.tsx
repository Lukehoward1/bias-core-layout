...
export default function AssetDetail() {
  ...
  // Nested news overlay (Calendar-style)
  const [newsEventOpen, setNewsEventOpen] = useState(false);
                ...
                <div className="mt-4 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-destructive">
                      <strong>Warning:</strong> High-impact news events scheduled within the next 4 hours. Consider
                      reducing exposure or waiting for data release before entering new positions.
                    </p>
                  </div>
                </div>
              </div>
