            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              {filteredPairs.map((asset) => (
                ...
                >
                  ...
                  >
                    <Star className={`h-4 w-4 ${isInWatchlist(asset.symbol) ? 'fill-yellow-400 text-yellow-400' : 'text-muted-foreground hover:text-foreground'}`} />
                  </Button>
                  ...
                  <CardHeader className="pb-3 pr-12">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-sm font-medium ${asset.priceChange.startsWith('+') ? 'text-success' : 'text-destructive'}`}>
                        {asset.priceChange}
                      </span>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        <span className={`text-xs font-medium ${asset.sentiment > 0 ? 'text-success' : asset.sentiment < 0 ? 'text-destructive' : 'text-muted-foreground'}`}>
